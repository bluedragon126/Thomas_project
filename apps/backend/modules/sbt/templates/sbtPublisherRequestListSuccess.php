	  ...
	  <!--<div id="sbt_publisher_request_content_div"  class="float_left widthall" style="padding-top:10px; width:480px;">-->
		  ...
		  <table width="50%" border="0" cellspacing="0" cellpadding="0" id="publisher_pending_request_list_table">
			<thead>
				...
				<th scope="col" width="10%"><a id="sortby_date" style="cursor:pointer;" class="float_left"><span class="float_left" style="width:105px;">Request Date<img src="/images/bg.gif" alt="down" /></span></a></th>
			...
			<?php endforeach; ?>
			<?php else: ?>
			<tr><td colspan="4"><?php echo 'No Result'; ?></td></tr>
			<?php endif; ?>
		  </table>
		  </form>
