...
<div class="forumlistingleftdiv">
  <div class="forumlistingleftdivinner" style="width:900px;">
   <div class="shoph3 widthall">Sbt Article Request</div>
	<div class="float_left listing">
	  <div id="article_request_menu_div" class="float_left widthall">
		<?php include_partial('global/article_request_menu',array('host_str'=>$host_str,'user_id'=>$user_id,'action'=>$action,'show_top_links'=>$show_top_links)) ?>
	  </div>
	  <div id="sbt_article_list_div"  class="float_left widthall" style="padding-top:20px;">
