...
<div class="maincontentpage">
  ...
  <div class="float_left widthall" style="padding:10px 0 10px 0;"><b><a class="blackcolor" href="<?php echo 'https://'.$host_str.'/backend.php/borst/createAd'?>">Create Advertisement</a>&nbsp;&nbsp;&nbsp;||&nbsp;&nbsp;&nbsp;<a class="blackcolor" href="<?php echo 'https://'.$host_str.'/backend.php/borst/archiveAdList'?>">Archive Ad List</a></b></div>
