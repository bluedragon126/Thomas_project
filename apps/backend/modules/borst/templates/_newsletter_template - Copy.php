                            ...
                            <td colspan="3" style="float: left; overflow: hidden;">
                                <table width="789" border="0">
                                    <tr>
                                      ...
                                      <td width="86">
                                      <table width="44" style="margin-top:12px">
                                                ...
                                                <tr>
                                                   <td height="10" style="font-size: 13px; font-family: Franklin Gothic Book Regular,Arial,Helvetica,sans-serif;  color: #232222;line-height: 2px; letter-spacing:1px; text-align:center; padding-top: 9px;"><?php echo date("M") == 'May' ? 'MAJ' : (date("M") == 'Oct' ? 'OKT' : strtoupper(date("M"))); ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size: 14px; font-family: Georgia, 'Times New Roman', Times, serif; color: #232222; font-weight:700; line-height: 18px; text-align:center; padding-top: 2px;"><?php echo ' ' . date("Y"); ?></td>
                                                </tr>
                                                <tr>
                            ...
                            <td style="width:786px;float:left; " colspan="3">
                                <table cellpadding="0" cellspacing="0" border="0"  style="width:786px;float:left; ">
                                    <tbody>
                                        ...
                                        <tr style="background: #9daeb8;width:786px;float:left; height:26px;  vertical-align: middle; margin-top:2px; margin-bottom:4px;"  >
                                        
                                            <td align="left" valign="middle" style="height:26px"><a href="http://www.borstjanaren.se/" style="letter-spacing: 0.6px; padding-left: 0px; float:left;font-family: Arial,Helvetica,sans-serif;position: relative;font-size: 11px; color: #FFFFFF;font-weight:normal; letter-spacing: 1px; text-decoration: none; width: 148px;">&nbsp;&nbsp;&nbsp;LÄS PÅ WEBBEN</a></td>
                                            
                                            <td align="left" valign="middle" style="height:26px"><a href="http://www.borstjanaren.se/sbt_user/sbtNewRegistration" style="letter-spacing: 0.6px;float:left;font-family: Arial,Helvetica,sans-serif;position: relative;font-size: 11px; color: #FFFFFF;font-weight:normal; letter-spacing: 1px;  text-decoration: none; width: 132px;">&nbsp;GRATIS KONTO    </a></td>
                                            
                                            <td align="left" valign="middle" style="height:26px"><a href="http://www.borstjanaren.se/borst/borstSubscriber" style="letter-spacing: 0.6px;float:left;font-family: Arial,Helvetica,sans-serif;position: relative;font-size: 11px; color: #FFFFFF;font-weight:normal; letter-spacing: 1px;  text-decoration: none; width: 102px;">&nbsp;&nbspPORTFÖLJ    </a></td>
                                            
                                            <td align="left" valign="middle" style="height:26px"><a href="http://www.borstjanaren.se/borst/borstNewsletter" style="letter-spacing: 0.6px;float:left;font-family: Arial,Helvetica,sans-serif;position: relative;font-size: 11px; color: #FFFFFF;font-weight:normal; letter-spacing: 1px;  text-decoration: none; width: 132px;">&nbsp;&nbspAVREGISTRERA    </a></td>
                                            
                                            <td align="left" valign="middle" style="height:26px"><a href="http://www.borstjanaren.se/borst/tipAFriendNewBt" style="letter-spacing: 0.6px;float:left;font-family: Arial,Helvetica,sans-serif;position: relative;font-size: 11px; color: #FFFFFF;font-weight:normal; letter-spacing: 1px;  text-decoration: none; width: 132px;">&nbsp;&nbspTIPSA EN VÄN    </a></td>
                                ...
                                <table width="300px" cellpadding="0" cellspacing="0" id="right_side_div">
                                    <tr id="ads_1" style="width: 300px;float: left;">
                                        ...
                                        <td id="nobj_ads_1">
                                            ...
                                            <span style="color: #232222; font-size: 10px; font-family: Franklin Gothic Book Regular,Arial,Helvetica,sans-serif; font-weight: normal; letter-spacing:0.5px;float: left;width: 100%; margin: -2px 0px 3px 0px;">ANNONS:</span>
                                            <span><a href="http://dagensindustri.se/kampanj/borstjan/" class="simplelink" style="text-align: center;">
                                                    <span class="float_left pbottom_5 ieadj" style="  width: 100%;">
                                                        ...
                                                        <div style="border-bottom: 4px solid #f15a22;height: 10px; margin-bottom: 5px;">&nbsp;</div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr style="width: 300px;float: left;">
                                        <td style="width:100%;padding: 14px 0px 5px 0px;">
                                            ...
                                            <img width="300px" style="margin: 2px 0px 1px 0px;" src="<?php echo $host ?>/images/new_home/bt_just_nu_latest_articles1.png" alt="" />
                                        ...
                                        <td>
                                            <ul style="padding-left: 15px; width: 225px;padding-bottom: 2px;color: #232222; list-style-position: inside;margin: 0;  font-family: Georgia, 'Times New Roman', Times, serif; line-height: 20px;">
                                                ...
                                                <?php foreach ($btList as $data): ?>
                                                    <li style="color: #828ba4;list-style-position: outside;width: 300px;"><a style="word-wrap:break-word;width: 300px;color: #828ba4; text-decoration: none; font-size: 14px; line-height:20px;" href="<?php echo $host . $link_type . $data->article_id ?>"><?php echo $data->title; ?></a></li>
                                                <?php endforeach; ?>
                                            </ul>
                                    ...
                                    <tr style="width: 300px;float: left;">
                                        <td style="width:100%;padding: 3px 0px 5px 0px;">
                                            ...
                                            <img width="300px" style="margin: 3px 0px -3px 0px;" src="<?php echo $host ?>/images/new_home/bt_just_nu_latest_articles2.png" alt="" />
                                    ...
                                    <tr id="blog_1" style="width: 300px;float: left;">
                                        ...
                                        <td id="nobj_blog_" >
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0">
                                                <tr>
                                                    <td COLSPAN=2><img src="<?php echo $host; ?>/images/new_home/askBT_logo_btjn.png" width="176" style="padding: 8px 0px 10px 20px;"/></td>
                                                </tr>
                                                <tr>
                                                    <td style="padding-bottom: 7px;">
                                                        <div style="font-family: Franklin Gothic Book Regular,Arial,Helvetica,sans-serif;font-size: 18px;color: #11cdde;letter-spacing:-0.3px; font-weight: 300; margin-left: 19px;">De senaste frågorna:</div>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr style="width: 300px;float: left;">
                                        ...
                                        <td>
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="300" style="background-color: #11cdde;border-top-left-radius: 18px;border-bottom-right-radius: 18px; padding: 12px 18px 12px 20px;">
                                                <tr>
                                          <td style="font-family: Georgia, 'Times New Roman', Times, serif; font-size: 13.5px; color: #c7f8fc;"><?php echo Date('Y-m-d', strtotime($post->enq_date)); ?> 
                                                    <span style="font-family: Franklin Gothic Book Regular,Arial,Helvetica,sans-serif; font-size: 13px; color: #ffffff;">&nbsp;&nbsp;<?php echo $post->enq_type; ?></span></td>
                                                    <td style="font-family: Franklin Gothic Book Regular,Arial,Helvetica,sans-serif; font-size: 12px; font-weight: 700; color: #f9f19a; text-align:right;"><?php echo $post->getReplyCount($post->id); ?> / <?php echo $post->visningar; ?></td>
                                                </tr>
                                                <tr><td colspan="3">
                                               <div style="border-bottom: 1px solid #ffffff; margin: 8px 0px 10px 0px; height: 0px;">&nbsp;</div>
                                                
                                                
                                                    <a style="font-family: Franklin Gothic Book Regular,Arial,Helvetica,sans-serif; font-size: 13px; color: #11305a; line-height: 18px; font-weight:700; text-decoration: none;"href="<?php echo $host . '/borst/enquiryDetails/enq_id/' . $post->id; ?>"><?php echo $post->enq_subject ?></a>
                                                    </td>
                                                </tr>
                                            </table>
                                            <table>
                                    ...
                                    <tr id="ads_2" style="width: 300px;float: left;">
                                        ...
                                        <td id="nobj_ads_2" valign="top">
                                            ...
                                            <div style="border-bottom: 4px solid #f15a22; margin-top: 20px; height: 0px;">&nbsp;</div>


                                            <span style="color: #232222; font-size: 10px; font-family: Franklin Gothic Book Regular,Arial,Helvetica,sans-serif; font-weight: normal; letter-spacing:0.5px; margin: 8px 0px 2px 0px; float: left;">ANNONS:</span>

                                            <span><?php echo html_entity_decode($ads[1]); ?></span>

                                            <br/>

                                            <div style="border-bottom: 4px solid #f15a22;height: 10px; margin: 2px 0px 12px;">&nbsp;</div>
...
<table width="826" cellpadding="0" cellspacing="0">
      ...
      <td colspan="3" style="float: left; color: #232222; font-size: 12px; font-family: Georgia, 'Times New Roman', Times, serif; letter-spacing: -0.3px; padding-left: 2px; width: 100%; background-color: #9daeb8; padding: 7px 0px;">
                            <span style="padding-left: 10px;">&nbsp;&nbsp; © Copyright Morningbriefing Börstjänaren AB <?php echo date('Y'); ?>
</span>
</tr>
