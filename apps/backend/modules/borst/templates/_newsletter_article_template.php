        ...
        <table width="<?php echo $side == 'left' ? '465' : '300' ?>" cellpadding="0" cellspacing="0" style="padding: <?php echo $side == 'left' ? '0px' : '0px' ?>;">
            <tbody>
                ...
                <tr><td valign="top">
                        ...
                        <table cellpadding="0" cellspacing="0" style=" width:100%; height: 4px; background-color: #d4dae4;border-bottom-right-radius: 40px; margin: 0px 0px 18px 0px; padding: 10px 0px 24px 8px;">
                            <tr>
                                <td>
                                    ...
                                    <a style="text-decoration:none;" href="<?php echo $host . $link_type . $article['article_id']; ?>" >
                                        <span style="font-family:Franklin Gothic Book Regular,Arial,Helvetica,sans-serif; color: #4e6579;font-size: 11px; font-weight: 300; float: none;padding: 0px; letter-spacing:0.4px;"><?php echo $date[2] . ' ' . $month[$date[1]] ?></span>

                                        <span style="font-family: Georgia, 'Times New Roman', Times, serif;color: #3b4c5b;font-size: 13px; font-weight: 700; float: none; margin: 0px 7px 0px  4px;">
                                            <?php echo $article["category"] ? $article["category"] : '' ?></span>

                                        <span style="font-family:Franklin Gothic Book Regular,Arial,Helvetica,sans-serif;color: #4e6579;font-size: 11px;text-transform: uppercase; font-weight: 300; float: none;letter-spacing:5px;"><?php echo $article["type"] ? $article["type"] : '' ?></span>
                                    </a>
                ...
                <tr><td style="font-weight: 700; letter-spacing:-0.7px; color: #232222;vertical-align: baseline; font-family: Georgia, 'Times New Roman', Times, serif; float: left;font-size: <?php echo $side == "left" ? "40px" : "22px" ?>;<?php echo $side == "left" ? "line-height: 45px;" : "line-height: 28px;" ?>margin: 0;padding-bottom: <?php echo $side == "left" ? "12px" : "2px" ?>;padding-top: 0px; position: relative;width: 100%;">
