    ...
    <table width="745"  style="float:left;" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
        <tbody>
            <tr style="width:745px;float:left">
                <td>
                    <table width="786"  style="float:left;" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr style="width:775px;float:left">
                                <!-- header -->
                                <td colspan="3" width="775px" style="float: left; overflow: hidden;">
                                        ...
                                        <?php endforeach; ?>
                                            ...
                                            <td width="300px" style="border-left: 1px solid #D3D6E1; border-right: 1px solid #D3D6E1;" valign="top" bgcolor="#ffffff">
                                                <table cellpadding="0" cellspacing="0" id="right_side_div">
                                                    <tr id="ads_1" style="width: 300px;padding: 0px 15px;float: left;">
                                                        <!-- first ad-->
                                                        <td id="nobj_ads_1">
...
<?php echo html_entity_decode($ads[0]); ?></span>
                                                    ...
                                                    <tr style="width: 300px;padding: 0px 15px;float: left;">
                                                            <!-- forum post -->
                                                            <td>
...
<p style="padding: 3px 0px 6px 0px;font-family: Arial,Helvetica,sans-serif;font-size: 17px; color: #EE8501;font-weight:normal; margin: 7px 0px -4px 0px;">Aktuella Forumtrådar</p>
                                                ...
                                                <?php endforeach; ?>
                                                     ...
                                                     <tr id="blog_1" style="width: 300px;padding: 0px 15px;float: left;">
                                                        <!-- popular bloggar -->
                                                        <td id="nobj_blog_" >
                                                            <span style="display: none;" class="n_article_top" >
                                                            ...
                                                            <table style="width: 300px;height: 220px;" cellpadding="0" cellspacing="0" border="0" >
                                                    ...
                                                    <tr style="width: 300px;padding: 0px 15px;float: left;">
                                                     ...
                                                     <tr id="ads_2" style="width: 300px;padding: 0px 15px;float: left;">
                                                                <!-- second ad-->
                                                                <td id="nobj_ads_2">
                                                                    <span style="display: none;" class="n_article_top" >
                                                                        <span style="visibility:hidden" class="next_nobj" ></span>
                                                        ...
                                                        <tr style="width:745px;float:left">
                                                            <td style="width:745px;float:left">
                                                                <table width="745"  style="float:left;" cellpadding="0" cellspacing="0">
                                                                    <tr ><td colspan="3" style="width:'775px';">
                                                                    
                                                                   
                                                                            <img src ="<?php echo $host ?>/newsletter/newsletter_footer.png" width="775"/>
                </td></tr>
        </table>
    </td>
</tr>
