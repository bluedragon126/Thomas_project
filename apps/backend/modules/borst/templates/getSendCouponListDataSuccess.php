<div class="shoph3 widthall">Coupon List</div>
...
<?php include_partial('borst/send_coupon_list_partial', array('pager'=>$pager,'purchase'=>$purchase,'product'=>$product,'subscription_types'=>$subscription_types,'selected_subscription_type'=>$selected_subscription_type,'page'=>$page)) ?>
</div>
</div>
