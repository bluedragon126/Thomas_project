   ...
   <div class="forumlistingleftdivinner" style="width:915px;">
	...
	<div id="subscription_other_links" class="float_left widthall" style="width:900px; margin-bottom:20px;">
		...
		<a href="<?php echo 'https://'.$host_str.'/backend.php/borst/sendSubscription' ?>">Send Subscription</a>&nbsp;&nbsp;
                <a style="font-weight:bold;" href="<?php echo 'https://'.$host_str.'/backend.php/borst/commaSeperatedList' ?>">Lista komma-separerad</a>&nbsp;&nbsp;
		...
		<div class="float_left listing">
		  <div class="float_left widthall" style="width:40%;">
			...
			<div class="backend_search_section float_left">
				...
				<td><input type="button" id="filter_subscription_button1" name="filter_subscription_button1" value="Sök"></td>
				<td><div id="filter_subscription_type_error" style="color: #FFFF00; width:200px; padding-left:10px;">&nbsp;</div></td>
				</tr>
				</table>
				</form>
			</div>
