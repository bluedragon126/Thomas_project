  ...
  <div class="float_left widthall" style="padding:10px 0 10px 0;"><b><a class="blackcolor" href="<?php echo 'https://'.$host_str.'/backend.php/borst/createAd'?>">Create Advertisement</a>&nbsp;&nbsp;&nbsp;||&nbsp;&nbsp;&nbsp;<a class="blackcolor" href="<?php echo 'https://'.$host_str.'/backend.php/borst/adList'?>">Ad List</a></b></b></div>
   <div class="forumlistingleftdivinner" style="width:915px;">
	...
	<div class="float_left"> 
	  ...
	  <table width="70%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td class="float_right"><input type="button" name="submit" id="searchArchiveAdList" value="Search"></td>		
		</tr>
	  </table>
	  </form>
	  </div>
	...
	<div id="sbt_adslist_outer" class="forumlistingleftdivinner" style="width:915px; border:0px solid red; font-size:11px;">
	  <div class="shoph3 widthall">Archive Advertisement List</div>
	  <div class="listing">
		...
		<input type="hidden" id="archive_ad_id" name="archive_ad_id"/>
                <input type="hidden" id="is_unarchive" name="is_unarchive"  />
...
<div id="unarchive_sbt_ad_confirm_box" title="Unarchive Sbt Ad Confirmation">
...
<div id="delete_sbt_ad_confirm_box_perm" title="Delete Sbt Ad Confirmation">
 <table width="100%"  border="0" cellspacing="3" cellpadding="0">
	<tr>
		<td id="delete_sbt_ad_msg_perm">Message:</td>
	</tr>
 </table>
</div>