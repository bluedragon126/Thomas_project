            ...
            <tr style="width:745px;float:left">
                <td>
                    <table width="745"  style="float:left;" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr style="width:715px;float:left">
                                <!-- header -->
                                <td colspan="3" width="715px" style="float: left; overflow: hidden;">
                                    <img style="margin: 0px 0px 2px 0px;" src="<?php echo $host; ?>/newsletter/colorband_top_newsletter.png">
                                    <table cellpadding="0" cellspacing="0">
                                        <tr valign="top">
                                            <td width="300px">
                                                <img src="<?php echo $host; ?>/newsletter/newsletter_BT_top.png" style="margin: 11px 0px 5px -1px;">
                                            </td>
                                            <td>
                                                <table  width="60px" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        <tr><td style="padding:31px 1px 0px 0px; color: #000000;font-family: Arial,Helvetica,sans-serif;font-size: 29px; font-weight:bold; letter-spacing: -1px; text-align:center;"> 
														
														<?php echo date("d") . ' ' ?> 
                                                        
                                                        </td></tr>
                                                        <tr>
                                                          <td style="padding:0px 2px 0px 0px; color: #000000;font-family: Arial,Helvetica,sans-serif;font-size: 12px; line-height:4px; font-weight:bold; text-align:center;">
														  <?php echo date("M") == 'May' ? 'MAJ' : (date("M") == 'Oct' ? 'OKT' : strtoupper(date("M"))); ?></td>
                                                        </tr>
                                                        <tr>
                                                          <td style="padding:3px 2px 0px 0px; color: #000000;font-family: Arial,Helvetica,sans-serif;font-size: 12px; line-height:13px; font-weight:bold; text-align:center;">
														  <?php echo ' ' . date("Y"); ?></td>
                                                        </tr>
                                                    </tbody>
                                            ...
                                            <td width="146px" style="padding:13px 5px 0px 0px;">
                                               <span style="padding: 0px 0px 0px 8px;font-size:12px;font-family: Arial,Helvetica,sans-serif; font-weight: bold;"><?php echo $sf_user->getAttribute('omxtime') ? $sf_user->getAttribute('omxtime') : date("H:i", time()) ?></span>
                                               
                                               
                                                    <table cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="border:2px solid; border-radius:10px; border-color:b0bbc8">
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding-left: 3px; ">
                                                            <table cellpadding="0" cellspacing="0">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <span style="font-weight:900;font-size:15px;font-family: Arial,Helvetica,sans-serif; margin-top: 0px;"><?php echo $sf_user->getAttribute('omxVal') ? $sf_user->getAttribute('omxVal') : '&nbsp;' ?></span>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding-left: 3px; ">
                                                            <span style="font-weight:bold;color:#5e99c3;font-family: Arial,Helvetica,sans-serif;font-size: 13px;"><?php echo $sf_user->getAttribute('omxIndexVal') ? $sf_user->getAttribute('omxIndexVal') : '&nbsp;' ?></span>
                                            ...
                                            <td width="146px" style="padding: 13px 0px 0px 1px;">
                                             <span style="padding: 0px 0px 0px 8px;font-size:12px;font-family: Arial,Helvetica,sans-serif; font-weight: bold;"><?php echo $sf_user->getAttribute('sptime') ? $sf_user->getAttribute('sptime') : date("H:i", time()) ?></span>
                                                <table cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="border:2px solid; border-radius:10px; border-color:b0bbc8">
                                                    <tr>
                                                      <td colspan="2" height="5px"></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style="padding-left: 5px;">
                                                            <table cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    <td  width="110px" >
                                                                        <span style="font-weight:bold;color:#5a6d89;font-family: Arial,Helvetica,sans-serif;font-size: 12px;"> S&P 500</span>
                                                                    </td>

                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <span style="font-weight:900;font-size:15px;font-family: Arial,Helvetica,sans-serif; margin-top: 0px;"><?php echo $sf_user->getAttribute('spVal') ? $sf_user->getAttribute('spVal') : '&nbsp;' ?></span>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td style="padding-left: 5px;">
                                                            <span style="font-weight:bold;color:#5e99c3;font-family: Arial,Helvetica,sans-serif;font-size: 13px;"><?php echo $sf_user->getAttribute('spIndexVal') ? $sf_user->getAttribute('spIndexVal') : '&nbsp;' ?></span>
                                                        </td>
                                                    </tr>
                                                     <tr>
                                                       <td colspan="2" height="3px"></td>
                            ...
                            <tr style="width:745px;float:left; ">
                                <td style="width:745px;float:left; " colspan="3">
                                    <table cellpadding="0" cellspacing="0" border="0"  style="width:745px;float:left; ">
                                        <tbody>
                                            <tr style="background: #ffffff;width:745px;float:left; height:  4px; vertical-align: middle; margin-top:2px;"  >
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" id="left_image_table">
                                    <tbody>
                                     ...
                                     <?php $img_count = $img_count<4? 4:$img_count;?>
                                          ...
                                          <tr>
                                                    <td>
                                                        <img src="<?php echo $host; ?>/newsletter/leftcolorstripbg_newsletter.png" alt="" style=" "/>
                                    ...
                                    <td width="436px" valign="top" >
                                        ...
                                        <?php endforeach; ?>
                                            ...
                                            <td width="269px" style="border-left: 1px solid #D3D6E1; border-right: 1px solid #D3D6E1;" valign="top" bgcolor="#ffffff">
...
<p style="padding: 3px 0px 6px 0px;font-family: Arial,Helvetica,sans-serif;font-size: 17px; color: #EE8501;font-weight:normal; margin: 7px 0px -4px 0px;">Aktuella forumtrådar</p>
                                                            ...
                                                            <?php foreach ($forum_post as $post): ?>
                                                                                    ...
                                                                                    <li style="color: #5589ad;width: 225px;line-height: 16px;">
                                                                                        <a style="word-wrap:break-word;width: 225px;font-family: Arial,Helvetica,sans-serif; color: #5589ad; text-decoration: none; font-size: 13px;" href=<?php echo $host . '/forum/commentOnForumTopic/forumid/' . $post->id; ?>><?php echo $post->rubrik ?></a>
                                                                                    </li>
                                                    ...
                                                    <tr style="width: 238px;padding: 0px 15px;float: left;">
                                                                <td style="width:100%;padding: 6px 0px 5px 0px;">
                                                                    ...
                                                                    <img width="238px" style="margin: 6px 0px 0px 0px;" src="<?php echo $host ?>/newsletter/senaste_artiklar.png" alt="" />
                                                     ...
                                                     <tr style="width: 238px;padding: 0px 15px;float: left;">
                                                                <!-- latest BT article  -->
                                                                <td>
                                                                    <ul style="padding-left: 15px; width: 225px;padding-bottom: 2px;color: #5589ad; list-style-position: inside;margin: 0;  font-family: Arial,Helvetica,sans-serif;">
                                                <?php $link_type = '/borst/borstArticleDetails/article_id/'; ?>
                                                <?php foreach ($btList as $data): ?>
                                                                                        <li style="color: #5589ad;list-style-position: outside;width: 225px; line-height: 14px;"><a style="word-wrap:break-word;width: 225px;color: #5e7a8d; text-decoration: none; font-size: 12px;" href="<?php echo $host . $link_type . $data->article_id ?>"><?php echo $data->title; ?></a></li>
                                                <?php endforeach; ?>
                                                                                   </ul>
                                                                ...
                                                                <tr style="background: #fadbd9;">
                                                                    ...
                                                                    <?php endif; ?>
                                                                        ...
                                                                        <td valign="top" style="width: 80px; padding-left: 5px;"><?php $profile = new SfGuardUserProfile(); ?>
                                                                            ...
                                                                            <span style="font-size: 11px; line-height: 13px;color: #7E99BC;font-family: Arial,Helvetica,sans-serif;"><?php echo substr($popular_blog->created_at, 0, 10); ?></span>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php foreach ($blog_post as $post): ?>
                                                                                ...
                                                                                <li style="color: #5589ad; width:225px;line-height: 19px;">
                                                                                    <a style="word-wrap:break-word;width: 225px;font-family: Arial,Helvetica,sans-serif; color: #5589ad ;text-decoration: none;" href="<?php echo $host . '/sbt/sbtBlogDetails/blog_id/' . $post->id; ?>"><?php echo $post->ublog_title ?></a>
                                                                                </li>
                                                            <?php endforeach; ?>
                                                                            </ul>
                                                                        </td>
                                            ...
                                            <?php endif; ?>
                                                        ...
                                                        <tr style="width:745px;float:left">
                                                            <td style="width:745px;float:left">
                                                                <table width="745"  style="float:left;" cellpadding="0" cellspacing="0">
                                                                    <tr ><td colspan="3" style="width:'715px';">
                                                                    
                                                                   
                                                                            <img src ="<?php echo $host ?>/newsletter/newsletter_footer.png" width="715"/>
                </td></tr>
        </table>
    </td>
</tr>
