...
<table style=" font-family: Arial, Helvetica, sans-serif; font-size:10pt;" border="0">
	...
	<tr><td>&nbsp;&nbsp;</td></tr>
	<tr><td><?php echo 'Klicka ' ?> <a href="https://https://www.thetradingaspirants.com/borst_shopshopProductDetail/product_id/21;"><?php echo 'här' ?></a><?php echo ' för att slippa onödigt avbrott i ditt abonnemang.' ?></td></tr>
<tr><td>&nbsp;&nbsp;</td></tr>
	<tr><td><?php echo 'Om länken inte fungerar kan du även klistra in följande i adressfönstret i din webbläsare: ' ?><a href="https://https://www.thetradingaspirants.com/borst_shopshopProductDetail/product_id/21"><?php echo 'https://https://www.thetradingaspirants.com/borst_shopshopProductDetail/product_id/21' ?></a></td></tr>
