...
<table style=" font-family: Arial, Helvetica, sans-serif; font-size:10pt;" border="0">
	...
	<tr><td>&nbsp;&nbsp;</td></tr>
	<tr><td><?php echo 'Din abonnemangsperiod på Börstjänaren är på väg att löpa ut.' ?></td></tr>
	<tr><td>&nbsp;&nbsp;</td></tr>
	<tr><td><?php echo 'Du är registrerad som Portföljabonnent med ursprungligt registreringsdatum '.$reg ?></td></tr>
	<tr><td>&nbsp;&nbsp;</td></tr>
	<tr><td><?php echo 'Om du vill fortsätta att ta del av Börstjänarens fulla service, inklusive portföljinformation och tips via E-post, vänligen betala in abonnemangsavgiften 250 kr snarast.' ?></td></tr>
	<tr><td>&nbsp;&nbsp;</td></tr>
