<table style=" font-family: Arial, Helvetica, sans-serif; font-size:10pt;" border="0">
	...
	<tr><td>&nbsp;&nbsp;</td></tr>
	<tr><td><?php echo 'Gratulerar! Din artikel "'.$analysis_data->analysis_title.'" har tilldelats medaljen "'.$medal_name.'" '; ?></td></tr>
	<tr><td>&nbsp;&nbsp;</td></tr>
	<?php if($record_data->award_note_by_admin):?>
	<tr><td><?php echo 'Redaktionen lämnar följande kommentar:' ?></td></tr>
	<tr><td>&nbsp;&nbsp;</td></tr>
