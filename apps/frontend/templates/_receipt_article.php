...
.rub_1{ color:#d6dde2; font-weight:normal; font-size:41px; letter-spacing:1px;}
	...
	<div style="float:left; position:relative; width:100%; padding-top:140px; border:none; ">
		<div style="float:left; position:relative; border:1px solid red;width:100%;">
				...
				<tr>
					<td style="padding-left:27%;">
						<table class="for_table" border="0" style=" width:500px;" cellpadding="0" cellspacing="0">
							...
							<tr>
							  <td class="rub_1" colspan="3">KVITTO</td></tr>
							<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
							<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
							<tr>
								...
								<td>&nbsp;</td>
                                                        ...
                                                        <tr>							
								<td class="width_130 column_heading" style="width:110px; height:22px;">Order nr: </td>
								<td class="top_border bottom_border font_arial" style="width:290px;"><?php echo $purchase_rec->id;?></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="bottom_border font_arial" style="width:290px;"><?php echo $purchase_rec->street.','.$purchase_rec->city.', '.$purchase_rec->zipcode ?></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td class="column_heading" style="width:110px;">Kundnr: </td>
    			...
    			<tr>
    				<td colspan="2" style="padding-left:27%;">
        				<table class="for_table" border="0" style=" width:500px;" cellpadding="0" cellspacing="0">		
							...
							<tr>
								<td class="column_heading" style="width:110px; height:22px;"><?php if($i==0):?><font style="color:#000000;"><b>Specifikation:</b></font><?php endif; ?></td>
								<td class="top_border bottom_border font_11" style="width:290px;"><?php echo $art_data->title; ?></td>
								<td class="bold_black pleft_10" aligh="right"><?php echo str_replace(',',' ',number_format($mul)); ?>:-</td>
							</tr>
							<tr>
								<td class="column_heading" style="width:110px; height:22px;">&nbsp;</td>
								<td class="bottom_border font_11" style="width:290px;"><?php echo $data->product_text ?></td>
			...
			<table class="for_table" border="0" align="center" width="100%" cellpadding="0" cellspacing="0">
    			<tr>
    				<td colspan="2" style="padding-left:27%;">
        				<table class="for_table" border="0" style=" width:500px;" cellpadding="0" cellspacing="0">					
							<tr><td style="height:22px;"><td>&nbsp;</td><td>&nbsp;</td></tr>
							<tr><td style="height:22px;"><td>&nbsp;</td><td>&nbsp;</td></tr>
							<?php if($shipping > 0): ?>
							<tr>
								<td class="column_heading" style="width:110px; height:22px;">&nbsp;</td>
							...
							<tr>
								...
								<td class="pleft_10" align="right"><?php echo str_replace(',',' ',number_format($vat, 2)); ?></td>
							</tr>
							<tr>
								<td class="column_heading" style="width:110px; height:22px;">&nbsp;</td>
								<td class="bold_black" style="width:290px;">Summa betalt:</td>
								<td class="pleft_10" align="right"><?php echo str_replace(',',' ',number_format($total_wth_shipping)); ?>:-</td>
							</tr>
						</table>
					</td>
