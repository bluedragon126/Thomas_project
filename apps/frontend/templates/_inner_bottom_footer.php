...
<?php } else { ?>
    ...
    <!--<div class='floatLeft margin_rgt_share'><a href="http://www.addthis.com/bookmark.php?v=250&amp;username=borstjanaren" class="addthis_button"><img src="/images/new_home/dela.png" height="15"/></a></div>-->
    <script type="text/javascript">var addthis_config = {"data_track_clickback":true};</script>
    <script type="text/javascript" src="http://s7.addthis.com/js/250/addthis_widget.js#username=borstjanaren"></script>
    <!-- AddThis Button END -->
    <div class='floatLeft margin_rgt_share'><a class="main_link_color" href="/borst/tipAFriendForm/article_id/<?php echo $article_data->article_id; ?>"><img src="/images/new_home/tipsa.png" height="15"/></a></div>
    ...
    <div class="bt_contact"><a href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/borst/contactUs'; ?>" <?php echo $third_menu == 'contact_us' ? 'class="select"' : ''; ?>>Kontakta oss</a></div>

    <div class="inner_page_divider_3">&nbsp;</div>
    <div class="sty_float_left">
        <span><img src="/images/new_home/testimonial_L.png" class="margin_testimonial" width="500"/></span>
    </div>
<?php } ?>
    <script>
