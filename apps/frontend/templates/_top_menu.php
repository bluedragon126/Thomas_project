...
<div class="nav-bar-wrap">
        ...
        <ul class="nav-bar">
            <li><a href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/borst/borstHome"><span class="text-uppercase borst <?php echo $parent_menu == 'top_borst_menu' ? 'nav-active' : '' ?>">BÖRSTJÄNAREN</span></a>
                <ul class="nav-bar-sub" id="first">
                    <li><a href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/borst/borstHome"><span  class="<?php echo $submenu == 'borst_menu_home' ? 'sub-active' : '' ?>">Hem</span></a></li>
                    ...
                    <li><a href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/borst/articleListMenu/obj_id/1795"><span class="<?php echo $submenu == 'borst_menu_subscriberlist' ? 'sub-active' : '' ?>">VM-Update</span></a></li>
                    <li><a href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/borst/articleListMenu/kat_id/12"><span class="<?php echo $submenu == 'borst_menu_subscriberlist' ? 'sub-active' : '' ?>">Högbergs hörna</span></a></li>                    
                </ul>
            </li>
            <li><a href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/borst_shop/borstShopHome"><span class="text-uppercase bt-shop <?php echo $parent_menu == 'top_bt_shop' ? 'nav-active' : '' ?>">BT-Shop</span></a>
                <ul class="nav-bar-sub" id="second">
                    ...
                    <li><a href="javascript:void(0);" onclick='gotoDiv("https://<?php echo $_SERVER['HTTP_HOST'] ?>/borst_shop/borstShopHome#utbildningar_title");' id="btshop_utbildningar"><span>Utbildningar</span></a></li>
                    <li id="bt_shop_abonnemang" class="popupmenu"><a id="btshop_abonnemang" href="javascript:void(0);" onclick='gotoDiv("https://<?php echo $_SERVER['HTTP_HOST'] ?>/borst_shop/borstShopHome#abonnemang_title");'><span>Abonnemang</span></a>
                    </li>
                    <li><a href="javascript:void(0);" onclick='gotoDiv("https://<?php echo $_SERVER['HTTP_HOST'] ?>/borst_shop/borstShopHome#metastock_title");' id="btshop_metastock"><span>Metastock</span></a></li>                    
    ...
    <div class="nav-bar-wrap-right top_menu_right">
       ...
       <span class="<?php echo $third_menu == 'sbtUserProfile' ? 'nav-active' : '' ?>"><a href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/sbt/sbtUserProfile/take_to_profile'; ?>">Mitt konto</a></span>
...
<div class="subnav-bar-wrap">
    ...
    <a href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/borst/borstWebinar'; ?>"><span class="subnav-bar <?php echo $third_menu == 'webinarium' ? 'sub-active' : '' ?>">Webinarium</span></a>    
        <a href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/borst/articleList'; ?>"><span class="subnav-bar <?php echo $third_menu == 'list' ? 'sub-active' : '' ?>">Lista</span></a>
        <a href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/borst/borstChronicles"><span class="subnav-bar <?php echo $third_menu == 'bt_skolan' ? 'sub-active' : '' ?>">Arkiv</span></a>
         <a href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/borst/borstRisk"><span class="subnav-bar <?php echo $third_menu == 'riskvarning' ? 'sub-active' : '' ?>"> Riskvarning </span></a>
         <a href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/borst/contactUs'; ?>"><span class="subnav-bar <?php echo $third_menu == 'contact_us' ? 'sub-active' : '' ?>">Kontakta oss</span></a>
