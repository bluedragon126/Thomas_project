...
<a href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/borst/faq" class="simplelink">
...
<a href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/sbt/sbtHome" class="simplelink">
...
<a href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/sbt/sbtHome" class="simplelink"><span class="float_left pbottom_5 ieadj"></span></a><a href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/sbt/sbtHome" class="simplelink"><span class="float_left pbottom_5 ieadj"><img width="269" height="70"  src="/images/ad5.png" /></span></a>
<?php endif;*/ ?>