...
<!--[if IE 7]>
<style>
.listing #blogtoplist_topic_list td.pleft_5{padding-left:0px;}
</style>
<![endif]-->
...
<div class="maincontentpage no-padding">
    <div class="pinkbg small_pinkbg">
        ...
        <div class="heading_violet"><?php echo $type == 'vote' ? __('Bloggpost: flest röster') : __('Blogg: mest läst') ?></div>

        <div class="float_left listing" id="blogtoplist_list_page" style="width:97%;">
