...
<div class="my_e_newsletter" id="my_e_newsletter_container">
	...
	<div class="float_left mrg_top_20">
		<div class="float_left"><input type="button" value="" id="my_e_newsletter_form_btn" name="assign_to_publisher_button" class="my_e_newsletter_save submit" onclick="saveMyENewsletterChanges()" /></div>
