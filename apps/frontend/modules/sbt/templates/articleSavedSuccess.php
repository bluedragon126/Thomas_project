...
<div class="shopinfo">
<span class="main_link_color"><?php echo __('To View the Article List, click')?><a href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/borst/articleList"><?php echo __(' here') ?></a></span>
</div>
<?php endif;?>
