...
<div class="maincontentpage">
    <div class="forumlistingleftdiv">
        <div class="forumlistingleftdivinner">
            ...
            <div class="float_left listing" id="user_list_page">
                    ...
                    <div class="pagination" id="user_list_listing">
                        <?php if ($pager->haveToPaginate()): ?>
                            ...
                            foreach ($links as $page): ?>
                                ...
                                <?php endif ?>
                            <?php endforeach ?>
                            <a id="<?php echo $pager->getNextPage(); ?>" class="cursor" class="cursor"> > </a> <a id="<?php echo $pager->getLastPage(); ?>" class="cursor"> <img src="/images/pag_arrow_right.jpg" alt="arrow" /> </a>
<?php endif ?>
                    </div>
                </div>
            </div>
