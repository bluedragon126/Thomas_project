...
<?php if($action_mode == 'upload'): ?>
	...
	<p class="caution"><strong><?php echo 'Note:' ?></strong><?php echo 'Endast JPG-, GIF- och PNG-bilder kan laddas upp. Maximal storlek f�r en bild �r 495 x 1000 px och 150 KB. St�rre bilder kommer, om m�jligt, att skalas ned.' ?></p>
	<ul>
