        ...
        <div class="btshopleftdiv">
            <div class="btshopleftdivinner">
                ...
                <div class="float_left widthall">
                        ...
                        <tr class="">
                            ...
                            <td  class="" colspan="2" >
                                <div class="float_left">
                                    <?php echo $profileForm['year_of_birth']->render(array('id' => 'year_of_birth', 'class' => 'form_labels padding_top_7_5px')) ?>     
                                    &nbsp; <span class = "form_labels  float_left mrg_lft_10"><?php echo __('Födelseår') ?></span> <?php echo $profileForm['year_of_birth']->renderError() ?>
                                    <span>&nbsp;</span>
                                    <div class="blank_12h widthall">&nbsp;</div>
                                </div>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="margin_top_10">
                        <tr>
                            <td class="error_list" colspan="2">
                                <div class="widthall float_left"><div class="g-recaptcha" data-sitekey=<?php echo $public_key; ?>></div></div>
                                <div class="float_left redcolor"><div class="for_labels" id="contact_enq_recaptcha_error"><?php echo $capcha_error; ?></div></div>
                            </td>
                        </tr>
                        <tr>
                            <td  class="blank_10h">&nbsp;</td>
                        </tr>
                    </table>
