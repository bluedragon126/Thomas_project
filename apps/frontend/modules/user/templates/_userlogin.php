<div class="user_login_main">
    ...
    <span class="floatLeft bt_head_login"><label><a class="cursor" href="http://<?php echo $_SERVER['HTTP_HOST'] ?>/user/forgetPassword">Glömt lösenord?</a></label></span>
    <span class="floatLeft"><a href="http://<?php echo $_SERVER['HTTP_HOST'] ?>/sbt_user/sbtNewRegistration"><button class="freeAccount cursor"></button></a></span>
    ...
    <span class="floatLeft"><label><a href="http://<?php echo $_SERVER['HTTP_HOST'] ?>/borst/borstAdvanceSearch" class="advsearch bt_head_login">Avancerad sökning</a></label></span>
