...
<div class="loginwrapper">
    <div class="width_per_59 floatLeft">
        ...
        <a href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/sbt/sbtUserProfile/take_to_profile/1'; ?>"><?php echo 'Mitt konto' ?></a>&nbsp;&nbsp;
        <a href="http://<?php echo $_SERVER['HTTP_HOST'] ?>/user/changePasswordForm"><?php echo 'Ändra lösenord' ?></a>&nbsp;&nbsp;
