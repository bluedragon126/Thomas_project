                ...
                <form name="loginform" id="loginform" method="post" action="<?php echo url_for('user/signin') ?>">
                    ...
                    if ($login_error) {
                        ?>
                            ...
                            <tr>
                                <td colspan="6" class="main_link_color padding_top_1" height="30 px" vertical-align="bottom"><a style="margin-left:110px" class="main_link_color" href="<?php echo 'https://' . $host_str . '/user/forgetPassword' ?>"><?php echo __('Glömt lösenord?') ?></a></td>
                            </tr>
                        </table>
                        <div class="blank_20h widthall">&nbsp;</div>
