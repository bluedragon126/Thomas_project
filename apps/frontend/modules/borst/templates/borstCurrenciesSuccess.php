            ...
            <?php if ($obj_count == 6 || $obj_count == 7 || $obj_count == 2 || $obj_count == 3): ?>
                    ...
                    <div class="home_heading_l_3_head_div">
                        <div class="home_heading_l_3_head_div">
                            <?php for ($i = 0; $i < 2; $i++): ?>
                                ...
                                <div class="home_heading_l_3_main_div <?php if ($i == 1) {
                        echo "margin_rgt_0";
                    } ?>">
                ...
                <?php for ($i = 0; $i < 2; $i++): ?>
                    <?php $date = explode('-', substr($arr[$i]['article_date'], 0, 10)); ?>
                            <div class="home_heading_l_3_txt_div mrg_top_6 <?php if ($i == 1) {
                        echo "margin_rgt_0";
                    } ?>">
    ...
    <?php endif; ?>
                ...
                <div class="advertinfo">
                    <div class="home_heading_l_small_txt">
                        ...
                        <a href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/borst/borstArticleDetails/article_id/<?php echo $twentyeight_2_thirtyfive[$l]['article_id']; ?>" class="article_dots_r cursor">...</a>
