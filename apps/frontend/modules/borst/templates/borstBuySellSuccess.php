  ...
  <?php $date = explode('-',substr($one_2_three[$a]['article_date'],0,10));?>
	<div class="articleftdiv autoheight">
		<div class="dattimeinfo"> 
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$one_2_three[$a]['article_id']; ?>" class="cursor">
			...
			<a href="<?php echo 'http://'.$host_str.'/borst/commentOnBorstArticle/article_id/'.$one_2_three[$a]['article_id']; ?>" class="cursor">
				<span class="chaticon"><?php echo $comment_cnt->getTotalCommentCount($one_2_three[$a]['article_id']) ?></span>
			</a>
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$one_2_three[$a]['article_id']; ?>" class="bluelink cursor"> 
				<span class="colorband"><img src="/images/smallcolorstrip.jpg" alt="strip" /> </span> 
			</a>
		</div>
		<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$one_2_three[$a]['article_id']; ?>" class="blackcolor cursor">
		...
		<div class="articleinfo">
			...
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$one_2_three[$a]['article_id']; ?>" class="bluelink cursor"> Läs mer ></a>
		</div>
		<div class="artdiv">
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$one_2_three[$a]['article_id']; ?>" class="bluelink cursor">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="float_left">
	  <tr>
		<td width="198" valign="bottom">
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$id_arr[0]; ?>" class="cursor">
...
-->				<img src="/uploads/articleIngressImages/<?php echo str_replace('.','_semimid.',$img45_arr[0]); ?>" />
		...
		<td width="10">&nbsp;</td>
		<td width="198" valign="bottom">
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$id_arr[1]; ?>" class="cursor">
<!--				<img src="/images/smallphoto.jpg" alt="photo" width="198" height="148" />
-->				<img src="/uploads/articleIngressImages/<?php echo str_replace('.','_semimid.',$img45_arr[1]); ?>" />
	  ...
	  <tr>
		...
		<td valign="top">
		<div class="dattimeinfo"> 
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$four_2_five[$b]['article_id']; ?>" class="cursor">
				<span class="date"><?php echo $date[2].' '.$month[$date[1]] ?></span> 
			...
			<a href="<?php echo 'http://'.$host_str.'/borst/commentOnBorstArticle/article_id/'.$four_2_five[$b]['article_id']; ?>">
				<span class="chaticon"><?php echo $comment_cnt->getTotalCommentCount($four_2_five[$b]['article_id']) ?></span>
			</a>
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$four_2_five[$b]['article_id']; ?>" class="bluelink">  
				<span class="colorband"><img src="/images/smallcolorstrip.jpg" alt="strip" /> </span> 
			</a>
		</div>
		<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$four_2_five[$b]['article_id']; ?>" class="cursor">
		...
		<div class="articleinfo"> 
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$four_2_five[$b]['article_id']; ?>" class="blackcolor cursor">
			<img src="/images/arrowright.jpg" alt="arrow" />
			<?php echo $four_2_five[$b]['image_text']?>
			</a>
			<a href="http://<?php echo $_SERVER['HTTP_HOST'] ?>/borst/borstArticleDetails/article_id/<?php echo $four_2_five[$b]['article_id']; ?>" class="bluelink"> Läs mer ></a>
		</div>
		</td>
  ...
  <?php $date = explode('-',substr($six_2_eight[$c]['article_date'],0,10));?>
	<div class="articleftdiv autoheight">
		<div class="dattimeinfo"> 
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$six_2_eight[$c]['article_id']; ?>" class="cursor">
				<span class="date"><?php echo $date[2].' '.$month[$date[1]] ?></span> 
			...
			<a href="<?php echo 'http://'.$host_str.'/borst/commentOnBorstArticle/article_id/'.$six_2_eight[$c]['article_id']; ?>" class="cursor">
				<span class="chaticon"><?php echo $comment_cnt->getTotalCommentCount($six_2_eight[$c]['article_id']) ?></span>
			</a>
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$six_2_eight[$c]['article_id']; ?>" class="bluelink cursor"> 
				<span class="colorband"><img src="/images/smallcolorstrip.jpg" alt="strip" /> </span> 
			</a>
		</div>
		<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$six_2_eight[$c]['article_id']; ?>" class="blackcolor cursor">
		...
		<div class="articleinfo">
			...
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$six_2_eight[$c]['article_id']; ?>" class="bluelink cursor"> Läs mer ></a>
		</div>
		<div class="artdiv">
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$six_2_eight[$c]['article_id']; ?>" class="bluelink cursor">
			<?php /*?><img src="/images/<?php echo $image_arr_13[$i] ?>" alt="photo" /><?php */?>
...
<?php */?>                <img src="/uploads/articleIngressImages/<?php echo str_replace('.','_semimid.',$img45_arr[1]); ?>" />
      ...
      <tr>
        ...
        <td valign="top">
        <div class="dattimeinfo"> 
            <a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$nine_2_ten[$d]['article_id']; ?>" class="cursor">
                <span class="date"><?php echo $date[2].' '.$month[$date[1]] ?></span> 
            ...
            <a href="<?php echo 'http://'.$host_str.'/borst/commentOnBorstArticle/article_id/'.$nine_2_ten[$d]['article_id']; ?>">
                <span class="chaticon"><?php echo $comment_cnt->getTotalCommentCount($nine_2_ten[$d]['article_id']) ?></span>
            </a>
            <a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$nine_2_ten[$d]['article_id']; ?>" class="bluelink">  
                <span class="colorband"><img src="/images/smallcolorstrip.jpg" alt="strip" /> </span> 
            </a>
        </div>
        <a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$nine_2_ten[$d]['article_id']; ?>" class="cursor">
        ...
        <div class="articleinfo"> 
            <a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$nine_2_ten[$d]['article_id']; ?>" class="blackcolor cursor">
            <img src="/images/arrowright.jpg" alt="arrow" />
            <?php echo $nine_2_ten[$d]['image_text']?>
            </a>
            <a href="http://<?php echo $_SERVER['HTTP_HOST'] ?>/borst/borstArticleDetails/article_id/<?php echo $nine_2_ten[$d]['article_id']; ?>" class="bluelink"> Läs mer ></a>
        </div>
        </td>
        <?php if($j==0):?><td>&nbsp;</td><?php endif; ?>
        <?php $j++; endfor; ?>
  ...
  <?php $date = explode('-',substr($eleven_2_thirteen[$e]['article_date'],0,10));?>
	<div class="articleftdiv autoheight">
		<div class="dattimeinfo"> 
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$eleven_2_thirteen[$e]['article_id']; ?>" class="cursor">
				<span class="date"><?php echo $date[2].' '.$month[$date[1]] ?></span> 
			...
			<a href="<?php echo 'http://'.$host_str.'/borst/commentOnBorstArticle/article_id/'.$eleven_2_thirteen[$e]['article_id']; ?>" class="cursor">
				<span class="chaticon"><?php echo $comment_cnt->getTotalCommentCount($eleven_2_thirteen[$e]['article_id']) ?></span>
			</a>
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$eleven_2_thirteen[$e]['article_id']; ?>" class="bluelink cursor"> 
				<span class="colorband"><img src="/images/smallcolorstrip.jpg" alt="strip" /> </span> 
			</a>
		</div>
		<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$eleven_2_thirteen[$e]['article_id']; ?>" class="blackcolor cursor">
		...
		<div class="articleinfo">
			...
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$eleven_2_thirteen[$e]['article_id']; ?>" class="bluelink cursor"> Läs mer ></a>
		</div>
		<div class="artdiv">
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$eleven_2_thirteen[$e]['article_id']; ?>" class="bluelink cursor">
			<?php /*?><img src="/images/<?php echo $image_arr_13[$i] ?>" alt="photo" /><?php */?>
...
<?php */?>				<img src="/uploads/articleIngressImages/<?php echo str_replace('.','_semimid.',$img45_arr[0]); ?>" />
	  ...
	  <tr>
		...
		<td valign="top">
		<div class="dattimeinfo"> 
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$fourteen_2_fifteen[$f]['article_id']; ?>" class="cursor">
				<span class="date"><?php echo $date[2].' '.$month[$date[1]] ?></span> 
			...
			<a href="<?php echo 'http://'.$host_str.'/borst/commentOnBorstArticle/article_id/'.$fourteen_2_fifteen[$f]['article_id']; ?>">
				<span class="chaticon"><?php echo $comment_cnt->getTotalCommentCount($fourteen_2_fifteen[$f]['article_id']) ?></span>
			</a>
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$fourteen_2_fifteen[$f]['article_id']; ?>" class="bluelink">  
				<span class="colorband"><img src="/images/smallcolorstrip.jpg" alt="strip" /> </span> 
			</a>
		</div>
		<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$fourteen_2_fifteen[$f]['article_id']; ?>" class="cursor">
		...
		<div class="articleinfo"> 
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$fourteen_2_fifteen[$f]['article_id']; ?>" class="blackcolor cursor">
			<img src="/images/arrowright.jpg" alt="arrow" />
			<?php echo $fourteen_2_fifteen[$f]['image_text']?>
			</a>
			<a href="http://<?php echo $_SERVER['HTTP_HOST'] ?>/borst/borstArticleDetails/article_id/<?php echo $fourteen_2_fifteen[$f]['article_id']; ?>" class="bluelink"> Läs mer ></a>
		</div>
		</td>
		<?php if($j==0):?><td>&nbsp;</td><?php endif; ?>
		<?php $j++; endfor; ?>
...
<div class="homemiddiv autoheight">
  ...
  <?php $date = explode('-',substr($sixteen_2_nineteen[$g]['article_date'],0,10));?>
	<div class="articleftdivmid">
		<div class="artmiddiv">
		<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$sixteen_2_nineteen[$g]['article_id']; ?>" class="bluelink cursor">
		...
		<div class="dattimeinfo">
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$sixteen_2_nineteen[$g]['article_id']; ?>" class="cursor"> 
				<span class="date"><?php echo $date[2].' '.$month[$date[1]] ?></span> 
			...
			<a href="<?php echo 'http://'.$host_str.'/borst/commentOnBorstArticle/article_id/'.$sixteen_2_nineteen[$g]['article_id']; ?>" class="cursor">
		...
		<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$sixteen_2_nineteen[$g]['article_id']; ?>" class="blackcolor cursor">
		...
		<div class="articleinfo"> 
			...
			<a href="http://<?php echo $_SERVER['HTTP_HOST'] ?>/borst/borstArticleDetails/article_id/<?php echo $sixteen_2_nineteen[$g]['article_id']; ?>" class="bluelink"> Läs mer ></a>
		</div>
  ...
  <?php $date = explode('-',substr($twenty_2_twentythree[$h]['article_date'],0,10));?>
	<div class="articleftdivmid">
		<div class="artmiddiv">
		<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$twenty_2_twentythree[$h]['article_id']; ?>" class="bluelink cursor">
		...
		<div class="dattimeinfo">
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$twenty_2_twentythree[$h]['article_id']; ?>" class="cursor"> 
				<span class="date"><?php echo $date[2].' '.$month[$date[1]] ?></span> 
			...
			<a href="<?php echo 'http://'.$host_str.'/borst/commentOnBorstArticle/article_id/'.$twenty_2_twentythree[$h]['article_id']; ?>" class="cursor">
		...
		<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$twenty_2_twentythree[$h]['article_id']; ?>" class="blackcolor cursor">
		...
		<div class="articleinfo"> 
			...
			<a href="http://<?php echo $_SERVER['HTTP_HOST'] ?>/borst/borstArticleDetails/article_id/<?php echo $twenty_2_twentythree[$h]['article_id']; ?>" class="bluelink"> Läs mer ></a>
		</div>
  ...
  <?php $date = explode('-',substr($twentyfour_2_twentyseven[$k]['article_date'],0,10));?>
	<div class="articleftdivmid">
		<div class="artmiddiv">
		<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$twentyfour_2_twentyseven[$k]['article_id']; ?>" class="bluelink cursor">
		...
		<div class="dattimeinfo">
			<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$twentyfour_2_twentyseven[$k]['article_id']; ?>" class="cursor"> 
				<span class="date"><?php echo $date[2].' '.$month[$date[1]] ?></span> 
			...
			<a href="<?php echo 'http://'.$host_str.'/borst/commentOnBorstArticle/article_id/'.$twentyfour_2_twentyseven[$k]['article_id']; ?>" class="cursor">
		...
		<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$twentyfour_2_twentyseven[$k]['article_id']; ?>" class="blackcolor cursor">
		...
		<div class="articleinfo"> 
			...
			<a href="http://<?php echo $_SERVER['HTTP_HOST'] ?>/borst/borstArticleDetails/article_id/<?php echo $twentyfour_2_twentyseven[$k]['article_id']; ?>" class="bluelink"> Läs mer ></a>
		</div>
	...
	<div class="home_right_column">
		...
		<div class="dattimeinfo"> 
			...
			<span class="colorband">
				<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$twentyeight_2_thirtyfive[$l]['article_id']; ?>" class="bluelink cursor"> <img src="/images/smallcolorstrip.jpg" alt="strip" /></a>
			</span> 
		</div>
		...
		<div class="advertinfo font_12"> 
			...
			<a href="http://<?php echo $_SERVER['HTTP_HOST'] ?>/borst/borstArticleDetails/article_id/<?php echo $twentyeight_2_thirtyfive[$l]['article_id']; ?>" class="bluelink"> Läs mer ></a>
		</div>
		<div class="advertdiv photo">
		<a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/borst/borstArticleDetails/article_id/'.$twentyeight_2_thirtyfive[$l]['article_id']; ?>" class="bluelink cursor">
