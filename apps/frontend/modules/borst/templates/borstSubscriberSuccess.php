            ...
            <div class="home_right_column">
                ...
                <div class="home_heading_l_txt dattimeinfo"> 
                    ...
                    <span class="colorband">
                        <a href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/borst/borstArticleDetails/article_id/' . $twentyeight_2_thirtyfive[$l]['article_id']; ?>"><img src="/images/new_home/arrow_bt.png"  class="margin_rgt_4"/></a>
                    </span>
