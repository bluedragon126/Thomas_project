<div class="maincontentpage">
        ...
        <div class="float_l_width_100 mrg_left_70">
            <div class="inner_page_content_main">
               ...
               <!--<div class="whp-border">&nbsp;</div>!-->
                ...
                <div class="float_left widthall">
                <a class="cursor blackcolor" href="<?php echo 'https://'.$host_str.'/borst/articleList/kat_id/18' ?>"><div class="whp_heading">Gästkrönikor</div>
 <div class="whp_subheading_Chro">Fristående skribenter</div>
                ...
                <div class="float_left widthall">
                  ...
                  <a class="cursor blackcolor" href="<?php echo 'https://'.$host_str.'/borst/articleList/kat_id/12' ?>">
 ...
 <div class="whp_subheading_Chro">Göran Högberg</div>
                 ...
                 <br> 
                  <a class="cursor blackcolor" href="<?php echo 'https://'.$host_str.'/borst/articleList/obj_id/368' ?>">
 ...
 <div class="whp_subheading_Chro">Henrik Hallenborg</div>
                  ...
                  <br>
                  <a class="cursor blackcolor" href="<?php echo 'https://'.$host_str.'/borst/articleList/obj_id/366' ?>">
 ...
 <div class="whp_subheading_Chro">med Harry Schüssler</div>
                  ...
                  <br>
                  <a class="cursor blackcolor" href="<?php echo 'https://'.$host_str.'/borst/articleList/obj_id/374' ?>">
 ...
 <div class="whp_subheading_Chro">med Thomas Sandström</div>
                  ...
                  <br>
                  <a class="cursor blackcolor" href="<?php echo 'https://'.$host_str.'/borst/articleList/kat_id/3' ?>">
