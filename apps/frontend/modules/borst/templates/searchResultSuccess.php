            ...
            <?php if (($pager) && ($pager->getNbResults() > 0)): ?>
                <div class="float_left listing">
                    ...
                    <div class="float_left widthall" id="btshop_result">
                        ...
                        <div class="paginationwrapperNew" style="float:left;">
                        <div class="forum_pag" id="search_listing">
                            <?php if ($pager->haveToPaginate()): ?>
                                <?php if ($pager->getFirstPage() != $pager->getPage()) { ?>
                                    <a id="<?php echo $pager->getFirstPage(); ?>" class="cursor"><span class="forum_pagination_first_img"></span><span class="forum_pagination_prev" >Första</span> <a id="<?php echo $pager->getPreviousPage(); ?>" class="cursor"> <span class="forum_pagination_prev_img"></span><span class="forum_pagination_prev margin_rgt_7">Föreg</span></a>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="forum_topic_list">
                            <tr id="column_header" class="headerList btshop_table_head">
                                <th class="width326 pad_lft_5"><span class="float_left width326 list_heading">Rubrik/Namn<img src="/images/bg.gif" alt="down" width = '20' /></span></th>
                                <th class="width150"><a id="sortby_btshop_article_title" name="btshop_result" class="float_left width150 cursor "><span class="float_left width136 list_heading">Artikel<img src="/images/bg.gif" alt="down" width = '20' /></span></a></th>
                                <th class="width100"><a id="sortby_btshop_type_id" name="btshop_result" class="float_left width108 cursor"><span class="float_left width100 list_heading">Typ<img src="/images/bg.gif" alt="down" width = '20' /></span></a></th>
                                <th class="forum_table_date_w"><a id="sortby_btshop_product_price" name="btshop_result" class="float_left forum_table_date_wcursor"><span class="float_left forum_table_date_w list_heading">Pris<img src="/images/bg.gif" alt="down" width = '20' /></span></a></th>
                            </tr>
                            <?php if ($btshop_pager): ?>
                                <?php
                                $i = 1;
                        ...
                        if ($i == 1) {
                            echo "class='padding_top_table'";
                                    ...
                                    ?> >                    
                                        <td class="list_topic_bt-sh width326 pad_lft_5"><?php echo $data->btshop_article_subtitle; ?></td>
                                        <td class="width150"><a class="blog_table_topic" style="color:#5ec5ed" href="https://<?php echo $host_str ?>/borst_shop/shopProductDetail/product_id/<?php echo $data->id; ?>"><?php echo $data->btshop_article_title; ?></a></td>
                                        <td class="width100"><a class="btshop_table_post shop_type cursor" style="color:#171200" name="<?php echo $data->btshop_type_id ?>"><?php echo $data->BtShopArticleType->btshop_type_name; ?></a></td>
                                        <td class="forum_table_date_w"><a class="adv_sr_price main_link_color" style="color:#e53520"><?php echo  BtShopPriceDetails::getMinPriceOfArticle($data->id, $order); ?></a></td>
