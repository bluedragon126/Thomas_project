                    ...
                    <?php if ($type == 'sbt'): ?>
                        ...
                        <?php $flagga = "usa.gif"; ?>
                            <tr id="borst_rec_row" class="classnot">
                                ...
                                <td width="66" class="noclass"><a class="cursor list_heading_kategori" href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/borst/articleList/sbt_kat_id/' . $article->analysis_category_id ?>" id="sbt_kat_id_<?php echo $article->analysis_category_id ?>"><span class="article_list_kategori"><?php echo $cat_arr[$article->analysis_category_id] ? $cat_arr[$article->analysis_category_id] : '&nbsp;'; ?></span></a></td>
                                <td width="11">&nbsp;</td>
                                <td width="80" class="noclass"><a class="cursor list_heading_typ" href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/borst/articleList/sbt_type_id/' . $article->analysis_type_id ?>" id="sbt_type_id_<?php echo $article->analysis_type_id ?>"><span class="article_list_typ"><?php echo $type_arr[$article->analysis_type_id] ? $type_arr[$article->analysis_type_id] : '&nbsp;'; ?></span></a></td>
                                <td width="11">&nbsp;</td>
