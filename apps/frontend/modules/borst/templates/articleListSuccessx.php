...
<?php endif ?>
                        ...
                        <?php if ($pager->haveToPaginate()): ?>
                            <?php if ($pager->getFirstPage() != $pager->getPage()) { ?>
                                ...
                                <div class="forum_popup_pagination_wrapper" noclick="1" >
                                    ...
                                    <div noclick="1" class="forum_drop-down-menu_go" onclick="javascript:paginationPopupGo(this);">GA</div>
                                </div>
            ...
            <div class="float_left widthall" id="article_list_page">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="article_list_table">
                    ...
                    <?php else: ?>
                        <div class="preamble" name="1"><span class="float_left"></span></div>
<?php endif; ?>
        ...
        <?php $flagga = "usa.gif"; ?>
                            <tr id="borst_rec_row" class="classnot">
                                <td width="72" class="list_date"><?php echo substr($article->created_at, 0, 10); ?></td>
                                <td width="10">&nbsp;</td>
                                <td width="276"><a id="sbt_article_title_<?php echo $article->id; ?>" class="list_topic" href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/sbt/sbtArticleDetails/article_id/<?php echo $article->id; ?>"><span class="article_list_text"><?php echo $article->analysis_title; ?></span></a></td>
                                <td width="21">&nbsp;</td>

                                <td width="70" class="noclass"><a class="cursor list_heading_kategori" href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/borst/articleList/sbt_kat_id/' . $article->analysis_category_id ?>" id="sbt_kat_id_<?php echo $article->analysis_category_id ?>"><span class="article_list_text"><?php echo $cat_arr[$article->analysis_category_id] ? $cat_arr[$article->analysis_category_id] : '&nbsp;'; ?></span></a></td>
                                <td width="8">&nbsp;</td>
                                <td width="81" class="noclass"><a class="cursor list_heading_typ" href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/borst/articleList/sbt_type_id/' . $article->analysis_type_id ?>" id="sbt_type_id_<?php echo $article->analysis_type_id ?>"><span class="article_list_text"><?php echo $type_arr[$article->analysis_type_id] ? $type_arr[$article->analysis_type_id] : '&nbsp;'; ?></span></a></td>
                                <td width="8">&nbsp;</td>
                                <td width="86" class="noclass"><a class="cursor list_heading_objekt" href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/borst/articleList/sbt_obj_id/' . $article->analysis_object_id ?>" id="sbt_obj_id_<?php echo $article->analysis_object_id ?>"><span class="article_list_text"><?php echo $object_arr[$article->analysis_object_id] ? $object_arr[$article->analysis_object_id] : '&nbsp;'; ?></span></a></td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <?php foreach ($pager->getResults() as $article): ?>
                            ...
                            ?>
                            <tr id="borst_rec_row" class="classnot">
                                <td width="72" class="<?php echo $article->art_statid == 2 ? 'redcolor' : '' ?> list_date"><?php echo substr($article->article_date, 0, 10); ?></td>
                                <td width="10">&nbsp;</td>
                                <td width="276" class="<?php echo $article->art_statid == 2 ? 'redcolor' : '' ?>"><a class=" <?php echo $article->art_statid == 2 ? 'redcolor' : 'list_topic' ?>" href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/borst/borstArticleDetails/article_id/<?php echo $article->article_id; ?>"><span class="article_list_text"><?php echo $article->title ? $article->title : '&nbsp;'; ?></span></a></td>
                                <td width="21">&nbsp;</td>
                                <td width="70" class=" <?php echo $article->art_statid == 2 ? 'redcolor' : 'noclass' ?>"><a class=" <?php echo $article->art_statid == 2 ? 'redcolor' : 'cursor list_heading_kategori' ?>" href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/borst/articleList/kat_id/' . $article->category_id ?>"><span class="article_list_text"><?php echo $cat_arr[$article->category_id] ? $cat_arr[$article->category_id] : '&nbsp;'; ?></span></a></td>
                                <td width="8">&nbsp;</td>
                                <td width="81" class=" <?php echo $article->art_statid == 2 ? 'redcolor' : 'noclass' ?>"><a class=" <?php echo $article->art_statid == 2 ? 'redcolor' : 'cursor list_heading_typ' ?>" href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/borst/articleList/type_id/' . $article->type_id ?>"><span class="article_list_text"><?php echo $type_arr[$article->type_id] ? $type_arr[$article->type_id] : '&nbsp;'; ?></span></a></td>
                                <td width="8">&nbsp;</td>
                                <td width="86" class=" <?php echo $article->art_statid == 2 ? 'redcolor' : 'noclass' ?>"><a class=" <?php echo $article->art_statid == 2 ? 'redcolor' : 'cursor list_heading_objekt' ?>" href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/borst/articleList/obj_id/' . $article->object_id ?>"><span class="article_list_text"><?php echo $object_arr[$article->object_id] ? $object_arr[$article->object_id] : '&nbsp;'; ?></span></a></td>
                            </tr>
                        <?php endforeach; ?>
<?php endif; ?>
                </table>
...
<div class="rightbanner padding_0 font_0 margin_top_ann" style="border:none;">
