...
<?php endif; ?>
        ...
        <?php $flagga = "usa.gif"; ?>
                            <tr id="borst_rec_row" class="classnot">
                                ...
                                <td width="10">&nbsp;</td>
                                <td width="276"><a id="sbt_article_title_<?php echo $article->id; ?>" class="list_topic" href="http://<?php echo $_SERVER['HTTP_HOST'] ?>/sbt/sbtArticleDetails/article_id/<?php echo $article->id; ?>"><span class="article_list_text"><?php echo $article->analysis_title; ?></span></a></td>
                                <td width="21">&nbsp;</td>

                                <td width="70" class="noclass"><a class="cursor list_heading_kategori" href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/borst/articleList/sbt_kat_id/' . $article->analysis_category_id ?>" id="sbt_kat_id_<?php echo $article->analysis_category_id ?>"><span class="article_list_text"><?php echo $cat_arr[$article->analysis_category_id] ? $cat_arr[$article->analysis_category_id] : '&nbsp;'; ?></span></a></td>
                                <td width="8">&nbsp;</td>
                    ...
                    <?php else: ?>
                        <?php foreach ($pager->getResults() as $article): ?>
                            ...
                            <tr id="borst_rec_row" class="classnot">
                                ...
                                <td width="10">&nbsp;</td>
                                <td width="276" class="<?php echo $article->art_statid == 2 ? 'redcolor' : '' ?>"><a class=" <?php echo $article->art_statid == 2 ? 'redcolor' : 'list_topic' ?>" href="http://<?php echo $_SERVER['HTTP_HOST'] ?>/borst/borstArticleDetails/article_id/<?php echo $article->article_id; ?>"><span class="article_list_text"><?php echo $article->title ? $article->title : '&nbsp;'; ?></span></a></td>
                                <td width="21">&nbsp;</td>
