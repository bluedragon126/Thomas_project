...
?> </li>
            ...
            <div class="floatRightNew">
                <?php //include_partial('borst_shop/payment_steps_partial', array('step' => 3, 'designType' => 1))  ?>
            </div>
        </div>
...
<div id="p_container" class="display-none">
    <?php include_partial('global/invoice_article', array('item_list' => $item_list, 'product_article' => $product_article, 'purchase_rec' => $purchase_rec, 'profile' => $profile, 'subscription' => $subscription)) ?>
</div>
