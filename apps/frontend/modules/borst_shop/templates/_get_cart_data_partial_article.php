                    ...
                    <?php foreach ($plus_article_product_detail as $plus_article_data):
                        ...
                        <li>
                            ...
                            <!--<div class="float_left shop_r_other_bread">
                                <?php //echo html_entity_decode($plus_article_data->text); ?> <span class="disp_inline"><a class="cursor" href="<?php //echo 'http://' . $host_str . '/borst_shop/shopArticleDetail/product_id/' . $plus_article_data->article_id; ?>">
