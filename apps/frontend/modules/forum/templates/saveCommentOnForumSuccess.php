<?php if ($update_only_forum_topic < 1): ?>
    ...
    foreach ($pager->getResults() as $data): ?>
        <div class="forum_comment_wrapper <?php if ($pager->getPage() != 1) {
            echo "margin_top_23px";
        } ?>">
            <div class="forum_comment_top_wraper float_left <?php if ($j1 % 2 == 0) {
        ...
        <?php $signiture = $new_profile->getUserData($data->author_id)->signature;
