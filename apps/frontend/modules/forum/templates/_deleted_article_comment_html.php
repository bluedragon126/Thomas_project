						...
						<div class="comment_content_wrapper float_left widthall">
							<div class="width_120 float_left comment_content_img_wrapper">
								...
								<div class="forum_comment_user_name widthall float_left">
									<?php if ($data->author_id!=0) : ?><a class="" href="<?php echo "https://".$host_str ?>/sbt/sbtMinProfile/id/<?php echo $data->author_id ?>"><?php echo ucwords($new_profile->getFullUserName($data->author_id)); ?></a><?php else: echo $data->skapare ; endif; ?>
								</div>
