...
// date: 2019/08/30 14:57:07
  ...
  'cache_dir' => 'C:\\xampp1.8.3\\htdocs\\second\\cache\\backend\\prod\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'C:\\xampp1.8.3\\htdocs\\second\\apps\\backend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\xampp1.8.3\\htdocs\\second\\cache\\backend\\prod\\template',
  'lifetime' => 86400,
  'prefix' => 'C:\\xampp1.8.3\\htdocs\\second\\apps\\backend/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    'param' => 
    array (
      'host' => 'mail2.hallenborgsandstrom.se',
      'port' => 587,
      'encryption' => NULL,
      'username' => 'noreply@hallenborgsandstrom.se',
      'password' => 'Kvtyw63945#',
    ),
  ),
  ...
  'spool_arguments' => 
  array (
    'path' => '/var/www/vhosts/hallenborgsandstrom.se/borstjanarentest/borst/spool',
  ),
))));
