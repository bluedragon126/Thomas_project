	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				{
					$url = 'https://' . $_SERVER['HTTP_HOST'] . str_replace('/admin/instructions.php', '/display.php', $_SERVER['REQUEST_URI']);
				}
				else
				{
	...
	<div class="col-md-6 col-lg-6">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<p><a href="https://www.hotscripts.com/listing/php-click-counter/" target="_blank"><i class="glyphicon glyphicon-globe"></i>&nbsp;Rate this Script @ Hot Scripts</a></p>
				<p><a href="https://php.resourceindex.com/rate?05375" target="_blank"><i class="glyphicon glyphicon-globe"></i>&nbsp;Rate this Script @ PHP Resource index</a></p>
			</div>
		</div>
	</div>
