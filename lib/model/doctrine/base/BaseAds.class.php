...
Doctrine_Manager::getInstance()->bindComponent('Ads', 'doctrine');
 ...
 * @method Ads     setId()            Sets the current record's "id" value
 * @method Ads     setAdPosition()    Sets the current record's "ad_position" value
 * @method Ads     setAdName()        Sets the current record's "ad_name" value
 * @method Ads     setAdType()        Sets the current record's "ad_type" value
 * @method Ads     setIsEnabled()     Sets the current record's "is_enabled" value
 * @method Ads     setCcounterId()    Sets the current record's "ccounter_id" value
 * @method Ads     setPriority()      Sets the current record's "priority" value
 * @method Ads     setAdTitle()       Sets the current record's "ad_title" value
 * @method Ads     setAdTarget()      Sets the current record's "ad_target" value
 * @method Ads     setDisplayCount()  Sets the current record's "display_count" value
 * 
 * @package    sisterbt
 * @subpackage model
